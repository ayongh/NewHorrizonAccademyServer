...
res.header("Access-Control-Allow-Origin","https://nhaclient.herokuapp.com");   //https://nhaclient.herokuapp.com  //http://localhost:3000 //change this to match  the Domain
